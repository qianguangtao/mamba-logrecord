...
public class PrintInitializer implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        final StringBuilder config = new StringBuilder()
                .append(String.format("%s【%s】 : %s\n", "app.common.env", "当前环境：[dev:本地|sit:系统集成测试|uat:用户验收测试|prod:生产]", this.commonProperties.getEnv()))
                .append(String.format("%s【%s】 : %s\n", "app.common.ip", "当前服务实例IP", this.commonProperties.getIp()))
                .append(String.format("%s【%s】 : %s\n", "app.common.startTime", "项目启动时间", this.commonProperties.getStartTime()))
                .append(String.format("%s【%s】 : %s\n", "app.common.swaggerEnabled", "swagger文档开关，true：开启，false：关闭", Objects.toString(this.commonProperties.isSwaggerEnabled(), "")));
        log.info("\n┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬ 环境配置 ┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬┬\n{}\n┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴ 环境配置 ┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴┴", config);
